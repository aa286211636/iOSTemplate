...
typedef NS_ENUM(NSUInteger, CustomSegmentStyle) {
    CustomSegmentStyleDefault,    /**< 指示杆和按钮的标题齐平*/
    CustomSegmentStyleFlush,      /**< 指示杆和按钮宽度齐平*/
};
NS_ASSUME_NONNULL_BEGIN
FOUNDATION_EXPORT int const CustomSegmentHeight;
...
@property (nonatomic) CustomSegmentStyle style;
...
@property (nonatomic, strong, nullable) UIColor *indicateColor; /**指示杆颜色*/
